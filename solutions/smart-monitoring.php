<?php
$page_title = "Smart Monitoring and Control Application - ICS";
...
<div class="rs-breadcrumbs img3">
    <div class="breadcrumbs-inner text-center">
        <h1 class="page-title">Smart Monitoring and Control Application</h1>
        <ul>
            <li>
                <a class="active" href="<?= $app_path ?>">Solutions</a>
            </li>
            <li>Smart Monitoring and Control Application</li>
        </ul>
    </div>
</div>
<!-- Breadcrumbs End -->
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="software-img">
                    <img src="<?= $app_path ?>assets/images/sps/solution/12.jpeg"
