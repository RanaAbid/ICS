<?php
$page_title = "Digital Architecture Configurator - ICS";
...
<div class="rs-breadcrumbs img3">
    <div class="breadcrumbs-inner text-center">
        <h1 class="page-title">Digital Architecture Configurator</h1>
        <ul>
            <li>
                <a class="active" href="<?= $app_path ?>">Solutions</a>
            </li>
            <li>Digital Architecture Configurator</li>
        </ul>
    </div>
</div>
<!-- Breadcrumbs End -->
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="software-img">
                    <img src="<?= $app_path ?>assets/images/sps/solution/10.jpg" alt="Digital Architecture Configurator"
                        class="rounded-pill">
                </div>
            </div>
        </div>
